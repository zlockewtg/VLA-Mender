...
Place: to the RIGHT of the dinner plate (white plate, ~13.5cm dia, 1.1cm thick).

Placement convention (LIVING_ROOM camera): world +y axis = image-right (right of plate).
...
# === Step 4: Compute target (right of plate) ===
# In LIBERO living-room scene: world +y axis = image-right.
# So "right of plate" = plate_y + offset (positive offset).
